...
model_file_name = "./model/best_model_rnn.hdf5";
result_file_name = "./result/best_model_rnn.res";
...
model.add(LSTM(16, return_sequences=True, input_shape=(256, 256)))
...
fwr = open("rnn-fpr.txt", 'w')
fwr.write(str(false_positive_rate))
fwr.close();

fwr = open("rnn-tpr.txt", 'w')
